...
export default function Restaurant({ navigation, route }) {
    ...
    const addFavorite = async() =>{
        if(!userLogged){
            toastRef.current.show("Para agregar un restaurante a favoritos debes estar logeado", 3000)
            return
        }
        setLoading(true)
        ...
        if(response.statusResponse){
            ...
            toastRef.current.show("No se pudo adicionar restaurante a favoritos, intenta mas tarde.", 3000)
        }
    }
    ...
    const removeFavorite = async () =>{
        ...
        if(response.statusResponse){
            ...
            toastRef.current.show("No se pudo eliminar restaurante a favoritos, intenta mas tarde.", 3000)
        }
        setLoading(false)
    }
